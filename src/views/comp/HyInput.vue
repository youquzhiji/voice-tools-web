...
<template>
    <div class="hy-input" :class="{'has-text': modelValue, 'anim': placeholder}">
        <input id="hy-input-inner" class="hy-input-inner" :value="modelValue"
               @input="passInput($event.target.value)" v-bind="$attrs"
               autocomplete="off"/>
        <div class="hy-input-placeholder" v-if="placeholder">
...
.hy-input.anim.has-text, .hy-input.anim:focus-within
    margin-top: 20px
